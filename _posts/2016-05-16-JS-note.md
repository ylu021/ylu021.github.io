...
```document.getElementsByTagName(Tagname)```  *Tagname是标签的名称，如p、a、img  
* 属性可能不唯一, 返回的是元素的数组      
* 有length属性
#### Node Attribute 
    getAttribute(attr)  
...
> 注意代码中的[0]，很关键！！！  
> 节点之间的空白符，在firefox、chrome、opera、safari浏览器是文本节点，所以IE是3，其它浏览器是7 Fix: 都写在一行 <ul><li>javascript</li><li>jQuery</li><li>PHP</li></ul>
#### node.firstChild
